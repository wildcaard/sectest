...
class MarkdownReportGenerator:
    ...
    def generate(self, report: Report, output_path: str) -> str:
        ...
        lines.append(f"**Date:** {sr.start_time.strftime('%Y-%m-%d %H:%M:%S') if sr.start_time else 'N/A'}  ")
        lines.append(f"**Duration:** {sr.duration}  ")
        lines.append(f"**Profile:** {sr.profile}  ")
        if meta:
            lines.append(f"**Generated by:** {meta.generated_by if hasattr(meta, 'generated_by') else 'Web Security Agent'}  ")
        lines.append("")
